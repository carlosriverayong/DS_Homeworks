...
## Nota: 
Se carga un archivo .txt con los paquetes instalados en el environment de Conda para que puedan instalarse en caso de querer ejecutar el codigo y asi no tener problemas de compatibilidad de librerias. Este puede instalarse con el siguiente comando 'conda install --file packages.txt'
